...
The loss system isn't working but there is infrastructure to make it work inside of the code. To play you need to load the code, set the two halt points, reset the registers and make sure the input buffer is clear, then hit run.
For this game I used https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://wchargin.com/lc3web/&ved=2ahUKEwjT5Y_vv6ONAxXkl4kEHU4TOx4QFnoECAoQAQ&usg=AOvVaw3nFip5fr6jgxI5MyB7wcNh 
